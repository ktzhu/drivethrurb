		...
		$.ajax({
			...
			error: function() {
				...
				if ( settings.showLoadMsg ) {
					...
					//show error message
					$( "<div class='ui-loader'><h1>"+ $.mobile.pageLoadErrorMessage +"</h1></div>" )
...
(function( $, window, undefined ) {
	...
	var $loader = $.mobile.loadingMessage ?	$( "<div class='ui-loader'>" + "<h1>" + $.mobile.loadingMessage + "</h1>" + "<span class='ui-icon ui-icon-loading'></span>" + "</div>" )	: undefined;

	$.extend($.mobile, {
		// turn on/off page loading message.
		showPageLoadingMsg: function() {
			$html.addClass( "ui-loading ui-body-a" );
